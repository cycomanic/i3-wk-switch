...
def change_workspace(name):
    ...
    LOG.debug(
        ...
        name, focused_workspace.output, pformat(focused_workspace, indent=2))
    ...
    want_workspace = get_workspace(name)
...
def main():
    ...
    parser.add_argument('workspace', metavar='WORKSPACE_NUM', type=str,
